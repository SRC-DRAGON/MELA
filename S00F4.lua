...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./S00F4.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S S00F4 -X kill
screen -S S00F4 ./S00F4
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/s00f4/Files_s00f4/master/File_Bot/commands.lua") 
...
os.execute('rm -rf S00F4.lua')
os.execute('wget https://raw.githubusercontent.com/s00f4/S00F4/master/S00F4.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس سورس صوفي وروظي\n ❃∫ الاصدار » { 1.3v}')
dofile('S00F4.lua')  
end
if text == 'الاصدار ❃' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس سورس صوفي وروظي \n ❃∫ الاصدار »{ 1.3v}')
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 's00f4')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's00f4')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if s00f41_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's00f4')..') \n ❃∫ '..s00f41_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/s00f4)}\n ❃∫ ["..s00f4_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/s00f4)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━━━━━━━━≫
 ❃∫ ↬s00f4 TEAM
 ≪━━━━━━━━━━━━━≫
 ❃∫ ↬[Channel S00F4](t.me/s00f4) 
≪━━━━━━━━━━━━━≫
 ❃∫ ↬[Information](t.me/s00f4)
≪━━━━━━━━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/CCFRR)
≪━━━━━━━━━━━━━≫
 ❃∫ ↬[The way his inauguration](https://t.me/s00f4/365)
≪━━━━━━━━━━━━━≫
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's00f4')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 's00f4')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
t = ' ❃∫ ملفات السورس سورس صوفي وروظي ↓\n ≪━━━━━━━━━━━━━≫ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/s00f4/Files_s00f4/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات سورس صوفي وروظي\n ❃∫ ملفات السورس ↓\n≪━━━━━━━━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━━━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس سورس صوفي وروظي ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/s00f4) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/s00f4/Files_s00f4/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('S00F4.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس سورس صوفي وروظي \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's00f4')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 's00f4')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 's00f4')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سورس صوفي وروظي').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سورس صوفي وروظي')
local s00f4_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سورس صوفي وروظي').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 's00f4')..')'
local iduser = result.sender_user_id_
...
zh = https.request('https://rudi-dev.tk/Amir1/s00f4.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫━━━━━━𝘽𝙆━━━━━━❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/s00f4.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/s00f4.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سورس صوفي وروظي')
